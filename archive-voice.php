    ...
    <div class="page-campaign__inner inner">
      <div class="page-campaign__tab">
        <ul class="common-tabs">
          <li class="common-tabs__tab is-current"><a href="<?php echo esc_url(get_post_type_archive_link('voice')); ?>">ALL</a></li>
          <?php
          $taxonomy_terms = get_terms('voice-course', array('hide_empty' => false));
          foreach ($taxonomy_terms as $taxonomy_term) :
          ?>
            <li class="common-tabs__tab"><a href="<?php echo esc_url(get_term_link($taxonomy_term, 'voice-course')); ?>"><?php echo esc_html($taxonomy_term->name); ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
